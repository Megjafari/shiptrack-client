    ...
    <div>
      ...
      <div style={{ padding: '32px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', padding: '24px' }}>
          ...
          <div style={{ fontFamily: 'IBM Plex Mono', fontSize: '20px', fontWeight: 600, color: 'var(--accent)', marginBottom: '12px' }}>
            {shipment.id}
          </div>
          ...
          {[
            ...
            <div key={row.label} style={{
              ...
              <span style={{ fontFamily: 'IBM Plex Mono', fontSize: '12px' }}>{row.value}</span>
            </div>
          ))}
        </div>
